...
// Use ~/.config/aws-auto-env/ as the config directory (XDG convention)
const CONFIG_DIR = path.join(os.homedir(), '.config', 'aws-auto-env');
...
const DEFAULT_SETTINGS = {
  ...
  logging: {
    enabled: false,
    logFile: path.join(CONFIG_DIR, 'aws-auto-env.log')
  }
};
